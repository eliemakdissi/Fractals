function z=browniantree(speed,animation,field,particles,xmax,ymax)
figure; axis equal;
hold on;
nField = field;
nParticles = particles;
x0=nField/2;y0=nField/2;
%see 'browniantree1' for POINTS representation; this 'browniantree' is for PIXELS representation
