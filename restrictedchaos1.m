%if the current vertex cannot be chosen in the next iteration, this fractal appears:
function nbiterations=restrictedchaos1(speed,animation,bgcolor,color,N,sides)
center_x = 600;
center_y = 600;
radius = 600;
num_sides = sides;
